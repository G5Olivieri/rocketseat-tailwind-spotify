...
export default function Home() {
  return (
    <div className="h-screen flex flex-col">
          ...
          <div className="grid grid-cols-3 gap-4 mt-4">
            ...
            >
              <Image
                ...
                width={104}
                height={104}
                alt="Album Bandida - MC Carol"
              />
              <strong>Bandida</strong>
      ...
      <footer className="bg-zinc-800 border-t border-zinc-700 px-6 py-4 flex justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-1">
            <strong className="font-normal">O Amor Acabou</strong>
            <span className="text-xs text-zinc-500">MC Carol</span>
          </div>
        </div>
